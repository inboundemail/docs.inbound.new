...
const { data, error } = await inbound.domain.getDnsRecords('dom_abc123')
if (error) {
  console.error('Error:', error)
} else {
  console.log('DNS Records:', data)
}
```
...
curl_setopt_array($curl, [
  CURLOPT_URL => 'https://inbound.new/api/v2/domains/dom_abc123/dns-records',
