...
<ResponseField name="verificationCheck" type="object" optional>
  ...
  <Expandable title="Verification check properties">
    ...
    <ResponseField name="dkimStatus" type="string">
      DKIM verification status.
    </ResponseField>
    <ResponseField name="dkimVerified" type="boolean">
      Whether DKIM is fully verified and enabled.
    </ResponseField>
    <ResponseField name="dkimTokens" type="array">
    ...
    <ResponseField name="mailFromStatus" type="string">
      MAIL FROM domain status: `Pending`, `Success`, `Failed`, or `NotSet`.
    </ResponseField>
    <ResponseField name="mailFromVerified" type="boolean">
