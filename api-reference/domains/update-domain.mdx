...
<ParamField body="catchAllEndpointId" type="string | null" optional>
...
<ResponseField name="receiptRuleName" type="string | null" optional>
...
const { data, error } = await inbound.domain.update('dom_abc123', {
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://inbound.new/api/v2/domains/dom_abc123');
...
if (error) {
  ...
  console.log('Catch-all disabled:', data);
}
```
