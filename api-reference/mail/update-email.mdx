...
<Check>
Documentation verified against API implementation on January 24, 2025. All endpoints, parameters, response fields, and examples match the actual code implementation.
</Check> 