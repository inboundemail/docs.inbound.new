---
title: "Mail Management (DEPRECATED)"
description: "Legacy mail management API - Use email.received.* methods instead"
---
...
**Migration Guide**: Replace `inbound.mail.*` with `inbound.email.received.*`
</Warning>
