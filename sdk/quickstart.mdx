...
<Tip>
You can use `agent@inbnd.dev` as the sender for testing without domain verification. Note: This email can only be used for sending new emails, not for replying to received emails.
</Tip>
</Step>
</Steps>
